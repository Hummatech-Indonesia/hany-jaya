...
interface LossCategoryInterface extends GetInterface, ShowInterface, StoreInterface, DeleteInterface, UpdateInterface, CustomPaginationInterface, WithRelationInterface, FirstLastestInterface
