        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <ul class="navbar-nav quick-links d-none d-lg-flex align-items-center">
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.index') ? 'text-primary' : '' }}" href="{{route('cashier.index')}}"><i class="ti ti-shopping-cart"></i> Penjualan</a>
                </li>
                @role('cashier')
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.selling.history') ? 'text-primary' : '' }}" href="{{route('cashier.selling.history')}}"><i class="ti ti-history"></i> Riwayat</a>
                </li>
                @else
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.admin.selling.history') ? 'text-primary' : '' }}" href="{{route('cashier.admin.selling.history')}}"><i class="ti ti-history"></i> Riwayat</a>
                </li>
                @endrole
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.list.debt') ? 'text-primary' : '' }}" href="{{route('cashier.list.debt')}}"><i class="ti ti-list"></i> Daftar Hutang</a>
                </li>
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.history.debt') ? 'text-primary' : '' }}" href="{{route('cashier.history.debt')}}"><i class="ti ti-book"></i> Riwayat Hutang</a>
                </li>
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link {{ request()->routeIs('cashier.history.pay.debt') ? 'text-primary' : '' }}" href="{{route('cashier.history.pay.debt')}}"><i class="ti ti-book"></i> Riwayat Pembayaran</a>
                </li>
            </ul>

            <div class="d-none d-md-block d-lg-none py-4">
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar>
                                    ...
                                    <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                        <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-1.jpg"
                                            ...
                                            alt="modernize-img" />
                                        <div class="ms-3">
                                            <h5 class="mb-1 fs-3">{{ UserHelper::getUserName() }}</h5>
                                            <span class="mb-1 d-block">{{ UserHelper::getUserRole() }}</span>
                                            <p class="mb-0 d-flex align-items-center gap-2">
                                                <i class="ti ti-mail fs-4"></i> {{ UserHelper::getUserEmail() }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="message-body">
                ...
                <div class="offcanvas-body h-n80" data-simplebar="" data-simplebar>
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.index') ? 'text-primary' : '' }}"
                        ...
                        @role('cashier')
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.selling.history') ? 'text-primary' : '' }}"
                        ...
                        @else
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.admin.selling.history') ? 'text-primary' : '' }}"
                        ...
                        @endrole
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.list.debt') ? 'text-primary' : '' }}"
                                href="{{route('cashier.list.debt')}}"
                                aria-expanded="false">
                                <span>
                                    <i class="ti ti-list"></i>
                                </span>
                                <span class="hide-menu">Daftar Hutang</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.history.debt') ? 'text-primary' : '' }}"
                                href="{{route('cashier.history.debt')}}"
                                aria-expanded="false">
                                <span>
                                    <i class="ti ti-book"></i>
                                </span>
                                <span class="hide-menu">Riwayat Hutang</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->routeIs('cashier.history.pay.debt') ? 'text-primary' : '' }}"
