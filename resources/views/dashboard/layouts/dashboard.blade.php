...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="modal-body message-body" data-simplebar="">
                        ...
                        <ul class="list mb-0 py-2">
                            <li class="p-1 mb-1 bg-hover-light-black">
                                <a href="#">
                                    <span
                                        class="fs-3 text-black fw-normal d-block"
                                        >Modern</span
                                    >
            ...
            <div class="offcanvas-body p-4">
                <div class="theme-option pb-4">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        ...
                        >
                            <i
                                class="ti ti-brightness-up fs-7 text-primary"
                            ></i>
                ...
                <div class="theme-direction pb-4">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        ...
                        >
                            <i
                                class="ti ti-text-direction-ltr fs-6 text-primary"
                            ></i>
                        ...
                        >
                            <i
                                class="ti ti-text-direction-rtl fs-6 text-dark"
                            ></i>
                ...
                <div class="theme-colors pb-4">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        <ul
                            class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors"
                        >
                            <li
                ...
                <div class="layout-type pb-4">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        ...
                        >
                            <i
                                class="ti ti-layout-sidebar fs-6 text-primary"
                            ></i>
                ...
                <div class="container-option pb-4">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        ...
                        >
                            <i
                                class="ti ti-layout-distribute-vertical fs-7 text-primary"
                            ></i>
                        ...
                        >
                            <i
                                class="ti ti-layout-distribute-horizontal fs-7"
                            ></i>
        ...
        @include('layouts.script') @yield('script')
    </body>
