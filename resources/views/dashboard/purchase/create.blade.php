            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <button
                            class="btn btn-info rounded-md px-4 mt-3"
                            type="submit"
                        >
                            Simpan
                        </button>
...
@endsection @section('script') @include('dashboard.purchase.widgets.repeater')
