@extends('dashboard.layouts.dashboard') @section('content')
    <div class="container-fluid">
        ...
        <div class="row justify-content-end">
            <div class="col-3">
                <input type="text" class="form-control" id="nametext" aria-describedby="name" placeholder="Produk" />
            </div>
            <div class="col-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4 flex-grow-1">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="t2">
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <i class="ti ti-share text-muted me-1 fs-4"></i>Edit
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item btn-delete" href="#"
                                                            data-url="{{ route('suppliers.destroy', $supplier->id) }}">
                                                            <i class="ti ti-download text-muted me-1 fs-4"></i>Hapus
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="mt-3">
                                        <span
                                            class="mb-1 badge rounded-pill font-medium bg-light-primary text-primary"><small>Chitato</small></span>
                                        <span
                                            class="mb-1 badge rounded-pill font-medium bg-light-primary text-primary"><small>Aqua</small></span>
                                    </div>
                                </div>
                            </div>
                        </div>
